...
void clip_polygon_against_plane(polygon_t* polygon, int plane) {
    ...
    // Start the previous with the vertex
    ...
    while (current_vertex != &polygon->vertices[polygon->num_vertices]) {
        ...
        if (current_dot * previous_dot < 0) {
            ...
            // Insert the intersection point to the list of "insdide verteices"
    ...
    // At the end, copy yhe list of inside vertices into the destination polygon
